...
import {jryqRouting}   from './jryq.routing';
...
@NgModule({
    imports: [jryqRouting, CommonModule,JryqRwhydBarModule,JryqZdfbBarModule,JryqZtfbPieModule, JryqWzsxtjBarModule,JryqZtqstLineModule,ArticlesSortModule, TabsModule, BreadLineModule, DropdownJudgedModule, DropdownDailyModule, DropdownWarningModule, DropdownArticlesOutModule, JryqArticlesListConentModule, JryqArticlesListOptionModule, JryqWzsxtjTableModule, JryqWzsxtjTopModule, JryqZtfbTableModule, JryqZtqstTopModule, JryqZtqstTableModule, JryqRwhydTableModule, JryqZdfbTopModule, JryqZdfbTableModule, JryqRwhydTopModule, JryqDailyModule],
    declarations: [JryqComponent],
    exports: [JryqComponent,CommonModule]

})
export class JryqModule {
}