...
import {byyqRouting}   from './byyq.routing';
...
import {DropdownDailyModule} from '../../components/dropdownDaily/dropdownDaily.module';
...
//舆情日报部分
import {ByyqMonthModule} from '../../components/byyqMonth/byyqMonth.module';



@NgModule({
    imports: [byyqRouting,JryqRwhydBarModule,JryqZdfbBarModule,JryqZtfbPieModule, JryqWzsxtjBarModule,JryqZtqstLineModule, CommonModule, ArticlesSortModule, TabsModule, BreadLineModule, DropdownJudgedModule, DropdownDailyModule, DropdownWarningModule, DropdownArticlesOutModule, JryqArticlesListConentModule, JryqArticlesListOptionModule, JryqWzsxtjTableModule, JryqWzsxtjTopModule, JryqZtfbTableModule, JryqZtqstTopModule, JryqZtqstTableModule, JryqRwhydTableModule, JryqZdfbTopModule, JryqZdfbTableModule, JryqRwhydTopModule, ByyqMonthModule],
    declarations: [ByyqComponent],
    exports: [ByyqComponent,CommonModule]

})
export class ByyqModule {
}